import { IconButton, Spacer } from '@repo/noya-designsystem';
import { SetNumberMode } from '@repo/noya-state';
...
export const DimensionsInspector = memo(function DimensionsInspector({
  x,
  y,
  width,
  height,
