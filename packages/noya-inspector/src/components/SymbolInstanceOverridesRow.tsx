...
import { ResetIcon } from '@repo/noya-icons';
import { ApplicationState, Overrides, Selectors } from '@repo/noya-state';
...
export const SymbolInstanceOverridesRow = memo(
  function SymbolInstanceOverridesRow({
    overrideValues,
    symbolMaster,
