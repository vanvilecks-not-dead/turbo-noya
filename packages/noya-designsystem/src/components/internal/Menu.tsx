import { useDesignSystemConfiguration } from '@repo/noya-designsystem';
import { ApplicationMenuItem } from '@repo/noya-embedded';
import { getShortcutDisplayParts } from '@repo/noya-keymap';
