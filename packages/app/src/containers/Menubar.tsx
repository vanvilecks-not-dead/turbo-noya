...
import { applicationMenu, ApplicationMenuItemType } from '@repo/noya-embedded';
import { HamburgerMenuIcon } from '@repo/noya-icons';
import { InspectorPrimitives } from '@repo/noya-inspector';
import { decode, encode } from '@repo/noya-sketch-file';
