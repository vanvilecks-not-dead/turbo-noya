...
import { useSelector, useWorkspace } from '@repo/noya-app-state-context';
import { Canvas, CanvasKitRenderer } from '@repo/noya-canvas';
import {
  darkTheme,
...
import { doubleClickToolbar } from '@repo/noya-embedded';
import { Size } from '@repo/noya-geometry';
import { MagnifyingGlassIcon } from '@repo/noya-icons';
import { AutoSizer, useSystemColorScheme } from '@repo/noya-react-utils';
import { DesignFile } from '@repo/noya-renderer';
import { Selectors, WorkspaceTab } from '@repo/noya-state';
